...
export const ENGINE_PARTS = {
    ...
    // Specific model parts
    'V6_Engine_Block': 'V6 Engine Block',
    'V6_Cylinder_Bank_Left': 'Left Cylinder Bank',
    'V6_Cylinder_Head_Right_Mesh': 'Right Cylinder Head',
    'V6_Cylinder_Head_Right_Mesh_1': 'Right Cylinder Head Intake',
    'V6_Cylinder_Head_Right_Mesh_2': 'Right Cylinder Head Exhaust',
    'V6_Crankshaft_Mesh': 'V6 Crankshaft',
    'V6_Crankshaft_Mesh_1': 'Crankshaft Main Bearing Journal',
    'V6_Crankshaft_Pulley_Hub': 'Crankshaft Pulley Hub',
    'V6_Piston_Mesh': 'Cylinder 1 Piston',
    'V6_Piston_Mesh_1': 'Cylinder 2 Piston',
    'V6_Piston_Mesh_2': 'Cylinder 3 Piston',
    'V6_Piston_Mesh_3': 'Cylinder 4 Piston',
    'V6_Piston_Mesh_4': 'Cylinder 5 Piston',
    'V6_Piston_Mesh_5': 'Cylinder 6 Piston',
    'V6_Piston_Mesh_6': 'Piston Assembly Component',
    'V6_Valve_Mesh': 'Intake Valve',
    'V6_Valve_Mesh_1': 'Exhaust Valve',
    'V6_Valve_Mesh_2': 'Second Intake Valve',
    'V6_Valve_Mesh_3': 'Second Exhaust Valve',
    'V6_Valve_Cover': 'V6 Valve Cover',
    'V6_Intake_Manifold_Mesh': 'V6 Intake Manifold',
    'V6_Intake_Manifold_Mesh_1': 'Intake Manifold Plenum',
    'V6_Intake_Manifold_Mesh_2': 'Intake Manifold Runner',
    'V6_Intake_Manifold_Mesh_3': 'Intake Manifold Throttle Body Mount',
    'V6_Intake_Manifold_Mesh_4': 'Intake Manifold Sensor Mount',
    'V6_Intake_Manifold_Gasket': 'Intake Manifold Gasket',
    'V6_Exhaust_Manifold_Left': 'Left Exhaust Manifold',
    'V6_Exhaust_Manifold_Right': 'Right Exhaust Manifold',
    'V6_Exhaust_Gasket_Left': 'Left Exhaust Manifold Gasket',
    'V6_Exhaust_Gasket_Right': 'Right Exhaust Manifold Gasket',
    'V6_Head_Gasket_Left': 'Left Head Gasket',
    'V6_Head_Gasket_Right': 'Right Head Gasket',
    'V6_Gasket_Set': 'Gasket Set',
    'V6_Head_Bolt_01': 'Cylinder Head Bolt 1',
    'V6_Head_Bolt_02': 'Cylinder Head Bolt 2',
    'V6_Head_Bolt_03': 'Cylinder Head Bolt 3',
    'V6_Head_Bolt_04': 'Cylinder Head Bolt 4',
    'V6_Head_Bolt_05': 'Cylinder Head Bolt 5',
    'V6_Head_Bolt_06': 'Cylinder Head Bolt 6',
    'V6_Head_Bolt_07': 'Cylinder Head Bolt 7',
    'V6_Head_Bolt_08': 'Cylinder Head Bolt 8',
    'V6_Head_Bolt_09': 'Cylinder Head Bolt 9',
    'V6_Oil_Pan': 'V6 Oil Pan',
    'V6_Oil_Filter': 'V6 Oil Filter',
    'V6_Timing_Belt': 'V6 Timing Belt',
    'V6_Accessory_Mount_Mesh': 'Accessory Bracket',
    'V6_Accessory_Mount_Mesh_1': 'Upper Accessory Bracket',
    'V6_Accessory_Mount_Mesh_2': 'Lower Accessory Bracket',
    'V6_Bracket_Mesh_09': 'Engine Support Bracket',
    'V6_Bracket_Mesh_09_1': 'Alternator Bracket',
    'V6_Bracket_Mesh_09_2': 'Power Steering Pump Bracket',
    'V6_Bracket_Mesh_09_3': 'Idler Pulley Bracket',
    'V6_Bracket_Mesh_09_4': 'A/C Compressor Bracket',
    'V6_Bracket_Mesh_09_5': 'Belt Tensioner Bracket',
    'V6_Bracket_Mesh_09_6': 'Accessory Drive Bracket',
...
export const TRANSMISSION_PARTS = {
    ...
    // Specific model parts
    'c_stick_shift_(loose_mesh)_2': 'Gear Shift Lever',
    'c_component#5_4': 'Transmission Main Case',
    'c_component#5_4_1': 'Transmission Extension Housing',
    'c_component#5_4_2': 'Bell Housing',
    'g_cylinder_7': 'Input Shaft',
    'g_cylinder_7_1': 'Input Shaft Bearing',
    'g_cylinder_7_2': 'Input Shaft Pilot Bearing',
    'g_cylinder_8': 'Output Shaft',
    'g_cylinder_8_1': 'Output Shaft Front Bearing',
    'g_cylinder_8_2': 'Output Shaft Rear Bearing',
    'g_cylinder_8_3': 'Output Shaft Seal',
    'g_object_11': 'Countershaft Assembly',
    'g_object_22': 'First Gear',
    'g_object_22_1': 'First Gear Synchronizer Hub',
    'g_object_24': 'Second Gear',
    'g_object_24_1': 'Second Gear Synchronizer Ring',
    'g_object_24_2': 'Third Gear',
    'g_object_24_3': 'Third Gear Synchronizer Hub',
    'g_object_24_4': 'Fourth Gear',
    'g_object_24_5': 'Fourth Gear Synchronizer Sleeve',
    'g_object_24_6': 'Fifth Gear',
    'g_object_24_7': 'Fifth Gear Synchronizer',
    'g_object_24_8': 'Fifth Gear Bearing',
    'g_object_25': 'Reverse Idler Gear',
    'g_object_25_1': 'Reverse Idler Shaft',
    'g_object_25_2': 'Reverse Gear',
    'g_object_26': 'Shift Fork 1st/2nd',
    'g_object_26_1': 'Shift Fork 3rd/4th',
    'g_object_26_2': 'Shift Fork 5th/Reverse',
    'g_object_28': 'Synchronizer Assembly',
    'g_object_28_1': 'Synchronizer Hub',
    'g_object_28_2': 'Synchronizer Sleeve',
    'g_object_28_3': 'Synchronizer Keys',
    'g_object_28_4': 'Blocker Ring',
    'g_object_28_5': 'Synchronizer Spring',
    'g_object_28_6': 'Gear Cone',
    'g_object_28_7': 'Detent Ball',
    'g_object_28_8': 'Shift Rail',
    'g_object_28_9': 'Interlock Plate',
    'g_object_28_10': 'Shift Lever Pivot',
    'g_object_28_11': 'Shift Boot Seal',
    'g_object_(loose_mesh)_3': 'Transmission Mount',
...
export const STEERING_PARTS = {
    ...
    // Specific model parts
    '(loose_entity)_2': 'Steering Wheel',
    '(loose_entity)_2_1': 'Steering Wheel Hub',
    'c_airbox_2': 'Steering Column Shroud',
    'c_airbox_2_1': 'Steering Column Upper Shroud',
    'c_component#1': 'Steering Rack Housing',
    'c_component#1_2': 'Steering Rack Inner Tie Rod Socket',
    'c_component#1_3': 'Steering Rack Boot Clamp',
    'c_component#5': 'Power Steering Pump',
    'c_component#5_2': 'Power Steering Reservoir',
    'c_weld_pro_star_(loose_mesh)': 'Steering Wheel Rim',
    'c_weld_pro_star_(loose_mesh)_2': 'Steering Wheel Spoke',
    'g_cylinder': 'Steering Column Shaft',
    'g_object': 'Steering Rack',
    'g_object_2': 'Pinion Gear',
    'g_object_3': 'Rack Teeth',
    'g_object_4': 'Inner Tie Rod',
    'g_object_5': 'Outer Tie Rod End',
    'g_object_6': 'Steering Rack Boot',
    'g_object_7': 'Tie Rod Adjustment Sleeve',
    'g_object_8': 'Steering Knuckle',
    'g_object_9': 'Steering Arm',
    'g_object_11': 'Steering Column Universal Joint',
    'g_object_12': 'Intermediate Steering Shaft',
    'g_object_13': 'Steering Gear Mounting Bracket',
    'g_object_14': 'Power Steering Line',
    'g_object_15': 'Power Steering Return Line',
    'g_object_17': 'Steering Stop Bolt',
    'g_object_18': 'Rack Mounting Bushing',
    'g_object_19': 'Pinion Bearing',
    'g_object_20': 'Rack Guide',
    'g_object_21': 'Steering Column Bearing',
    'g_object_22': 'Column Lock Mechanism',
    'g_object_23': 'Steering Angle Sensor',
    'g_object_34': 'Control Valve Spool',
    'g_object_34_1': 'Torsion Bar',
    'g_object_40': 'Wheel Hub Assembly',
    'g_object_40_1': 'Wheel Bearing',
    'g_object_49': 'Lower Ball Joint',
    'g_object_49_1': 'Ball Joint Boot',
    'g_object__(loose_mesh)': 'Steering Damper',
...
export const SUSPENSION_PARTS = {
    ...
    'Radius_Rod': 'Radius Rod',
    'Tire': 'Tire',
    'Upper_Arm_and_Damper_Spring': 'Upper Control Arm Assembly',
    'tmpkjcnard__ply__C_tmpkjcnard__ply_Defintion__002': 'Lower Control Arm',
    'tmpkjcnard__ply__C_tmpkjcnard__ply_Defintion__005': 'Ball Joint Assembly',
    'tmpkjcnard__ply__C_tmpkjcnard__ply_Defintion__006': 'Steering Knuckle',
    'tmpkjcnard__ply__C_tmpkjcnard__ply_Defintion__008': 'Wheel Hub Assembly',
};
...
export const BRAKE_PARTS = {
    ...
    // Specific model parts
    'Wheel': 'Wheel',
    'Wheel001': 'Front Wheel',
    'Rear_Wheel': 'Rear Wheel',
    'Rear_Wheel001': 'Rear Wheel',
    'Caliper001': 'Brake Caliper',
    'Adjustable_Proportioning_Valve': 'Adjustable Proportioning Valve',
    'Combination_Valve': 'Combination Valve',
    'Metering_Valve': 'Metering Valve',
    'Residual_Valve': 'Residual Valve',
    'Residual_Valve001': 'Residual Valve',
    'T_Fitting': 'T-Fitting',
    'Flex_Line002': 'Flexible Brake Hose',
    'Circle_004001': 'Brake Disc Surface',
    'Circle_004001_1': 'Inner Rotor Surface',
    'Circle_008': 'Brake Rotor Assembly',
    'Circle_010001': 'Wheel Hub Mount',
    'Circle_010001_1': 'Hub Bearing Surface',
};
...
export const ELECTRICAL_PARTS = {
    ...
    'Battery_Cable001': 'Positive Battery Cable',
    'Battery_Cable002': 'Negative Ground Cable',
    'Battery_Cable003': 'Auxiliary Power Cable',
    'Battery_Cable004': 'Secondary Ground Strap',
    'Main_Fuse_Block': 'Main Fuse Block',
    'Charge_Indicator': 'Charge Indicator',
    'Charging_System_Harness': 'Charging System Harness',
    'tmpzm4bo0d5_ply__C_tmpzm4bo0d5_ply_Defintion__005': 'Ignition Switch Connector',
    'tmpzm4bo0d5_ply__C_tmpzm4bo0d5_ply_Defintion__010': 'Electrical Junction Connector',
};
